...
export interface TranslationKeys {
  ...
  settings: {
    ...
    lightMode: string;
    systemTheme: string;
    gettingApiKeys: string;
    openrouterSetup: string;
    whyOpenrouter: string;
    whyOpenrouterDesc: string;
    privacyDataManagement: string;
    privacyProtected: string;
    privacyNotes: string[];
    clearStoredData: string;
    clearDataDesc: string;
    clearAllData: string;
    usageTips: string;
    modelSelection: string;
    modelSelectionDesc: string;
    costQuality: string;
    costQualityDesc: string;
    imageQuality: string;
